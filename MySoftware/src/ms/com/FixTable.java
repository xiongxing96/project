...
//					System.out.println(tempV);
			...
			for( int i=0;i<list.size();i++ ){
				...
				if(flag==1){JOptionPane.showConfirmDialog(null,"该员工信息已修改", "友情提示",JOptionPane.OK_OPTION);}
...
//		}
	...
	public void info(String str){
		...
		for(int i=0;i<e.length;i++){
			...
			else if(e[i].equals("足球"))
				hb2.setSelected(true);
			else if(e[i].equals("羽毛球"))
				hb3.setSelected(true);
			else if(e[i].equals("游泳"))
				hb4.setSelected(true);
			else if(e[i].equals("电竞"))
